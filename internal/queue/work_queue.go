...
func NewWorkQueue() *WorkQueue {
	return NewWorkQueueWithConfig(DefaultMaxRetries, DefaultInitialRetryDelay, DefaultMaxRetryDelay)
}

// NewWorkQueueWithConfig creates a new WorkQueue with custom retry configuration
func NewWorkQueueWithConfig(maxRetries int, initialDelay, maxDelay time.Duration) *WorkQueue {
	wq := &WorkQueue{
