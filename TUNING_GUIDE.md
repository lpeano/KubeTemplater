...
| `CACHE_TTL` | 300s | 60s | 600s | General cache lifetime |
| `POLICY_CACHE_TTL` | 60s | 30s | 600s | Policy cache (webhook & workers) |
...
| `QUEUE_MAX_RETRY_CYCLES` | 3 | 0 | 10 | Max cycles before pause (0=unlimited) |
...
env:
  ...
  - name: POLICY_CACHE_TTL
    value: "60"  # Security-focused, 1 minute
...
env:
  ...
  - name: CACHE_TTL
    value: "240"
  - name: POLICY_CACHE_TTL
    value: "60"  # Keep security-sensitive TTL short
  - name: PERIODIC_RECONCILE_INTERVAL
    value: "50"
  - name: QUEUE_MAX_RETRIES
    value: "5"
...
env:
  ...
  - name: CACHE_TTL
    value: "180"
  - name: POLICY_CACHE_TTL
    value: "45"  # Balanced security/performance
  - name: PERIODIC_RECONCILE_INTERVAL
    value: "45"
  - name: QUEUE_MAX_RETRIES
    value: "7"
